...
const ICONS = {
    ...
    sun: `
        ...
        >
            ...
            <path d="M17.66 17.66L19.07 19.07" stroke-linecap="round"/>
            <path d="M2 12H4" stroke-linecap="round"/>
            <path d="M20 12H22" stroke-linecap="round"/>
            <path d="M4.93 19.07L6.34 17.66" stroke-linecap="round"/>
            <path d="M17.66 6.34L19.07 4.93" stroke-linecap="round"/>
    ...
    instagram: `
        ...
        >
            ...
            <rect
                ...
                height="18"
                rx="5"
                stroke="url(#bhInstagramGradient)"
                stroke-width="2"
            />
    ...
    return `
        ...
        >
            ...
            >
                ...
                <circle cx="30" cy="23" r="7" fill="currentColor" opacity=".92"/>
                <circle cx="50" cy="23" r="7" fill="currentColor" opacity=".92"/>
                <circle cx="40" cy="17" r="8.5" fill="currentColor" opacity=".92"/>
                <circle cx="40" cy="27" r="9.5" fill="currentColor" opacity=".92"/>
                ...
                >
                    ...
                    <line x1="27" y1="45" x2="53" y2="67"/>
                    <line x1="25" y1="47" x2="29" y2="43"/>
                    <line x1="29" y1="51" x2="33" y2="47"/>
                    <line x1="33" y1="55" x2="37" y2="51"/>
...
#bh-navbar {
    ...
    box-shadow: 0 5px 25px rgba(36,26,20,.08);
...
.bh-brand-mark {
    ...
    box-shadow: 0 6px 18px rgba(168,52,31,.10);
...
.bh-logo:hover .bh-brand-mark {
    transform: translateY(-2px) rotate(-1.5deg);
    box-shadow: 0 10px 25px rgba(168,52,31,.18);
}
...
.bh-nav-link.bh-active::after {
    ...
    background: linear-gradient(90deg,#a8341f,#c9862f);
}
...
.bh-nav-dropdown-panel {
    ...
    border-radius: 12px;
    box-shadow: 0 14px 30px rgba(36,26,20,.14);
    z-index: 100000;
}
...
.bh-nav-dropdown-trigger[aria-expanded="true"] .bh-dropdown-chevron {
...
.bh-lang-button {
    ...
    border-radius: 999px;
    background: linear-gradient(135deg,#fff8eb,#f8e4c2);
    color: #8f2b19;
    font-size: 12px;
    font-weight: 850;
    cursor: pointer;
...
.bh-lang-button:hover {
    ...
    box-shadow: 0 7px 18px rgba(168,52,31,.16);
}
...
.bh-menu-button {
    ...
    color: #6b3f2d;
    cursor: pointer;
    box-shadow: 0 3px 10px rgba(36,26,20,.07);
...
#bh-mobile-menu {
    ...
    box-shadow: 0 18px 35px rgba(36,26,20,.12);
}
...
.bh-mobile-active {
    ...
    border-color: rgba(168,52,31,.14) !important;
    color: #a8341f !important;
    font-weight: 800 !important;
}

.bh-mobile-active .bh-mobile-icon {
    background: rgba(168,52,31,.12);
    color: #a8341f;
}
...
.bh-mobile-control {
    ...
    border-radius: 13px;
    background: linear-gradient(135deg,#fff,#f6f1e9);
    color: #6b3f2d;
    font-family: inherit;
    font-size: 13px;
    font-weight: 800;
...
.bh-footer-cta-card {
    ...
    gap: 30px;
    padding: 30px 34px;
    border: 1px solid rgba(168,52,31,.20);
    border-radius: 24px;
    background: linear-gradient(
        135deg,
        #6f281c,
    ...
    color: white;
    box-shadow: 0 18px 40px rgba(111,40,28,.20);
}
...
.bh-footer-social-link:hover {
    ...
    box-shadow: 0 10px 22px rgba(36,26,20,.15);
}
...
.dark .bh-lang-button {
    ...
    background: linear-gradient(135deg,#3b2814,#4a3015);
}
...
.dark .bh-menu-button {
    color: #f8d27a;
    border-color: #57534e;
    background: linear-gradient(145deg,#292524,#211f1d);
}
...
.dark .bh-mobile-active .bh-mobile-icon {
    background: rgba(245,158,11,.12);
    color: #f59e0b;
}

.dark .bh-mobile-submenu {
...
.dark .bh-mobile-controls {
    border-top-color: #44403c;
}

.dark .bh-mobile-control {
    color: #f5d07a;
    border-color: #57534e;
    background: linear-gradient(135deg,#292524,#211f1d);
}
...
[dir="rtl"] .bh-mobile-link:hover .bh-mobile-arrow {
    ...
    header.innerHTML = `
        ...
        <header id="bh-navbar">
            ...
            <div id="bh-mobile-menu">
                ...
                <div class="bh-mobile-controls">

                    <button
                        type="button"
                        id="bh-mobile-lang-button"
                        class="bh-mobile-control"
                        aria-label="${getDirTitle(currentDirection)}"
                        title="${getDirTitle(currentDirection)}"
                    >

                        <span class="bh-mobile-control-icon">
                            ${ICONS.globe}
                        </span>

                        <span id="bh-mobile-lang-label">
                            ${getDirLabel(currentDirection)}
                        </span>
